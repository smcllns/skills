---
name: path-to-goal
description: A status update format for a goal-focused software-engineering culture of rapid, evidence-based technical decision-making. Alias unconfuse.
---
...
If I something like write `B?` it means `My gut sense is option B is best, but I don't have good enough information/data on the tradeoffs or consequences of this choice. Send follow up confirmation with more detail on why my selection is better and worse than the next best alternative`
