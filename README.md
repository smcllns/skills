...
| Skill | Description |
|---|---|
| [`path-to-goal`](path-to-goal/SKILL.md) | A status update format for a goal-focused software-engineering culture of rapid, evidence-based technical decision-making. FKA unconfuse-me. |
